...
from libdocs.llmchecker.llmchecker_ray import LLMChecker
...
def main():
    ...
    parser.add_argument(
        ...
        type=str,
        default="deberta",
        choices=["deberta", "mistral", "zephyr"],
        help="Name of the model to use to clean the data. Defaults to 'deberta'.",
    )
    parser.add_argument(
        "--model-instances",
        dest="modelInstances",
